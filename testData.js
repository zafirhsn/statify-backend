...
request.get({url: "http://localhost:3000/getuser/12180700019"}, (err, res, body)=> {
  
  let jsonbody = JSON.parse(body)
  user.data.artists.push(jsonbody.data.artists[2]);
  user.data.artists.push(jsonbody.data.artists[1]);
  user.data.artists.push(jsonbody.data.artists[0]);

  user.data.tracks.push(jsonbody.data.tracks[2]);
  user.data.tracks.push(jsonbody.data.tracks[1]);
  user.data.tracks.push(jsonbody.data.tracks[0]);
